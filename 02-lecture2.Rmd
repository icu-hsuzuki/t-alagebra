...
:::{.definition}
The matrix $C$ is _reducible_ if and only if there is a bipartition $\{1, 2, \ldots, n\} = X^+ \cup X^-$ (disjoint union of nonempty sets) such that $C_{ij} = 0$ for all $i\in X^+$, and for all $j\in X^-$, and for all $i\in X^-$, and for all $j\in X^+$,i.e.,
$$ C \sim \begin{pmatrix} \ast & O \\ O & \ast \end{pmatrix}.$$
:::

:::{.definition}
The matrix $C$ is _bipartite_ if and only if there is a bipartition $\{1, 2, \ldots, n\} = X^+ \cup X^-$ (disjoint union of nonempty sets) such that $C_{ij} = 0$ for all $i,j\in X^+$, and for all $i,j\in X^-$, i.e.,
...
2. $\mathrm{dim}V_0 = 1$.  
3. $\theta_r \geq -\theta_0$.  
4. $\theta_r = \theta_0$ if and only if $C$ is bipartite.
:::
...
_Proof of Theorem \@ref(thm:pf)_

1. Let $\langle , \rangle$ denote the dot product on $V = \mathbb{R}^n$. Set
\begin{align}
B & = \theta I - C\\
...
_Proof of Theorem \@ref(thm:pf) 2._
...
_Proof of Theorem \@ref(thm:pf) 3._
...
_Proof of Theorem \@ref(thm:pf) 4._
...
:::{.definition}
$\Gamma$ is said to be _bipartite_ if the adjacency matrix $A$ is bipartite. That is, $X$ can be written as a disjoint union of $X^+$ and $X^-$ such that $X^+, X^-$ contain no edges of $\Gamma$. 
:::
