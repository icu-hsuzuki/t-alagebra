...
:::{.definition}
A map $\sigma: X \to X'$ is an _isomorphism_ of graphs whenever;
...
:::{.definition}
Suppose $\Gamma = \Gamma'$. Above isomorphism $\sigma$ is called an _automorphism_ of $\Gamma$. Then set $\mathrm{Aut}(\Gamma)$ of all automorphisms of $\Gamma$ becomes a finite group under composition.
:::

:::{.definition}
If $\mathrm{Aut}(\Gamma)$ acts transitive on $X$, $\Gamma$ is called _vertex transitive_.
:::
