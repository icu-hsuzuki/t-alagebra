...
\begin{lemma}
\protect\hypertarget{lem:thin-module-stucture}{}\label{lem:thin-module-stucture}With above notation, the following hold.
...
\begin{proof}
\((i)\) Set as in Lemma \ref{lem:thin-module-stucture},
...
Recall by Lemma \ref{lem:thin-module-stucture} \((iiib)\) that
...
& = x_i\|w_{i-1}\|^2.
\end{align}
by Lemma \ref{lem:thin-module-stucture} \((ii)\).
Also,
\begin{align}
...
The measure \index{measure} \(mm = m_W\) is the function
