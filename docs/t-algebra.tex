...
\hypertarget{lec29}{%
\chapter{\texorpdfstring{Relations of \(A, A^*\)}{Relations of A, A\^{}*}}\label{lec29}}
...
& = A^3A^*-A^*A^3 - (\beta+1)(A^2A^*A-AA^*A^2)-\gamma(A^2A^*-A^*A^2)-\delta(AA^*-A^*A)\label{eq:aastar}\\
0 & = [A^*, {A^*}^2A-\beta^* A^*AA^* + A{A^*}^2 - \gamma^*(A^*A+AA^*) - \delta^* A]\label{eq:astarbracket}\\
& = {A^*}^3A - A{A^*}^3 - (\beta+1)({A^*}^2AA^*-A^*A{A^*}^2)-\gamma^*({A^*}^2A-A{A^*}^2)-\delta^*(A^*A-AA^*).\label{eq:astara}
\end{align}
