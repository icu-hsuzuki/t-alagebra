...
\hypertarget{technical-memo}{%
\section*{Technical Memo}\label{technical-memo}}
\addcontentsline{toc}{section}{Technical Memo}
...
\begin{center}\includegraphics{t-algebra_files/figure-latex/unnamed-chunk-13-1} \end{center}
...
\hypertarget{some-open-problems-concerning-distance-regular-graphs-the-thin-condition-and-the-q-polynomial-property}{%
\section*{\texorpdfstring{Some Open Problems Concerning Distance-Regular Graphs, the Thin Condition, and the \(Q\)-Polynomial Property}{Some Open Problems Concerning Distance-Regular Graphs, the Thin Condition, and the Q-Polynomial Property}}\label{some-open-problems-concerning-distance-regular-graphs-the-thin-condition-and-the-q-polynomial-property}}
\addcontentsline{toc}{section}{Some Open Problems Concerning Distance-Regular Graphs, the Thin Condition, and the \(Q\)-Polynomial Property}
